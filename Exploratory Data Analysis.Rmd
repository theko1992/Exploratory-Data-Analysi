...
## step 2: unzip data
listZip <- unzip("./data/household_power_consumption.zip", exdir = "./data")

t <- read.table(listZip, header=TRUE, sep=";", na.strings = "?", colClasses = c('character','character','numeric','numeric','numeric','numeric','numeric','numeric','numeric'))
